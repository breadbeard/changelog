...
Scenario: Output changelog for the HEAD release
    ...
    And the output should contain "Test last commit [64c8e27](https://github.com/dvantuyl/changelog/64c8e27)"
    And the output should contain "[ENG-5955](https://windermeresolutions.atlassian.net/browse/ENG-5955): Test JIRA Tag [e864030](https://github.com/dvantuyl/changelog/e864030)"
...
Scenario: Prepend HEAD release changelog to file
    ...
    And the file "CHANGELOG.markdown" should contain "[CL.0.1.20120121.0](https://github.com/dvantuyl/changelog/tree/CL.0.1.20120121.0)"
    And the file "CHANGELOG.markdown" should contain "Test last commit [64c8e27](https://github.com/dvantuyl/changelog/64c8e27)"
    And the file "CHANGELOG.markdown" should contain "[ENG-5955](https://windermeresolutions.atlassian.net/browse/ENG-5955): Test JIRA Tag [e864030](https://github.com/dvantuyl/changelog/e864030)"
